...
async function run() {
  try {
    ...
    const Column = require('./A2_Javascript/models/column'); 
    // Require your Task class here
    const Task = require('./A2_Javascript/models/task'); // Adjust the path as needed
    const Sprint = require('./A2_Javascript/models/sprint'); // Adjust the path as needed
    const { privateEncrypt } = require("crypto");

    const User = require('./A2_Javascript/models/user'); // Adjust the path as needed
